...
const loader = new GLTFLoader(manager).setPath("/assets/models/medieval_fantasy_book/");
...
function init() {
    ...
    light.position.set(1.5, 12, 1.25);
    scene.add(light);
    //renderer
...
function onSelect() {
    if (reticle.visible && !modelLoaded) {
        loader.load("ARModelKhaled9.1.gltf", function (gltf) {
